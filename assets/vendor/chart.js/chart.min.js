!function (t, e) {
    ...
    const G = (t, e) => "string" == typeof t && t.endsWith("%")
            ? parseFloat(t) / 100
            : t / e,
        Z = (t, e) => "string" == typeof t && t.endsWith("%")
            ? parseFloat(t) / 100 * e
            : +t;
    function J(t, e, i) {
    ...
    function gi(t, e, i, s) {
        ...
        return null !== l && (
            (!ct(o) || o === i || (l = pi(r, a, o, l, s), null !== l)) && oi(Array.from(r), [""], n, o, (() => function (t, e, i) {
    ...
    const Si = t => 0 === t || 1 === t,
        ...
        Ci = {
            ...
            easeInElastic: t => Si(t)
                ? t
                : Pi(t, .075, .3),
            easeOutElastic: t => Si(t)
                ? t
                : Di(t, .075, .3),
            easeInOutElastic(t) {
                const e = .1125;
            ...
            easeInOutBounce: t => t < .5
                ? .5 *Ci.easeInBounce(2 * t)
                : .5 *Ci.easeOutBounce(2 * t - 1) + .5
        };
    function Oi(t, e, i, s) {
        return {
            x: t.x + i * (e.x - t.x),
    ...
    function Ri(t, e, i) {
        return function (t, e) {
            ...
            let s = Li.get(i);
            return s || (s = new Intl.NumberFormat(t, e), Li.set(i, s)),
            s
        }(e, i).format(t)
    }
    function Ei(t, e, i) {
    ...
    var hs = Object.freeze(
        {__proto__: null, _detectPlatform: ls, BasePlatform: Ui, BasicPlatform: Xi, DomPlatform: rs}
    );
    ...
    class Ps {
        ...
        _resolveElementOptions(t, e = "default", i) {
            ...
            return f.$shared && (f.$shared = r, n[o] = Object.freeze(Ss(f, r))),
            f
        }
    ...
    function Gs(t, e) {
        let i = qs.get(t);
        return i || (i = e(), qs.set(t, i), Ks.add(i)),
        i
    }
    const Zs = (t, e, i) => {
        const s = lt(e, i);
    ...
    const tn = t => U(t) && Object
        .getOwnPropertyNames(t)
        .reduce(((e, i) => e || dt(t[i])), !1);
    ...
    class dn {
        constructor(t, e) {
            ...
            if (o) 
                throw new Error(
                    "Canvas is already in use. Chart with ID '" + o.id + "' must be destroyed befor" +
                    "e the canvas can be reused."
                );
            ...
            const l = this
                    .platform
                    .acquireContext(n, r.aspectRatio),
                h = l && l.canvas,
                c = h && h.height,
                d = h && h.width;
            this.id = j(),
        ...
        _resize(t, e) {
            ...
            this._aspectRatio = this.aspectRatio,
            ke(this, a, !0) && (this.notifyPlugins("resize", {size: o}), J(i.onResize, [
                this, o
        ...
        _handleEvent(t, e, i) {
            ...
            i && (this._lastEvent = null, J(n.onHover, [
                t, a, this
            ], this), r && J(n.onClick, [
                t, a, this
            ], this));
    ...
    function xn(t) {
        ...
        const l = () => {
            32767 !== o && -32768 !== o && (
                ct(a) && (r = Math.min(r, Math.abs(o - a) || r)),
                a = o
            )
        };
            ...
            for (r = 0; r < o; ++r) 
                if (l = s[r], l.controller.options.grouped) {
                    if (void 0 !== e) {
                        const t = l
                            .controller
                            .getParsed(e)[l.controller._cachedMeta.vScale.axis];
                        if ($(t) || isNaN(t)) 
                            continue
                    }
                    if (
                        (!1 === n || -1 === a.indexOf(l.stack) || void 0 === n && void 0 === l.stack) && a.push(l.stack),
                        l.index === t
                    ) 
                        break
                }
    ...
    class Pn extends Ps {
        ...
        updateElements(t, e, i, s) {
            ...
            for (let r = e; r < e + i; r++) {
                ...
                h && (l.options = this.resolveDataElementOptions(
                    r,
                    e.active
                        ? "active"
                        : s
    ...
    class Dn extends Ps {
        ...
        updateElements(t, e, i, s) {
            ...
            for (m = e; m < e + i; ++m) {
                ...
                p && (o.options = g || this.resolveDataElementOptions(
                    m,
                    i.active
                        ? "active"
                        : s
            ...
            let {start: a, count: r} = function (t, e, i) {
                ...
                if (t._sorted) {
                    ...
                    d && (n = jt(Math.min(
                        ...
                        i
                            ? s
                            : re(e, l, a.getPixelForValue(h)).lo
                    ), 0, s - 1)),
                    o = u
                        ? jt(Math.max(
                            re(r, a.axis, c).hi + 1,
                            i
                                ? 0
                                : re(e, l, a.getPixelForValue(c)).hi + 1
                        ), n, s) - n
                        : s - n
                }
            ...
            tooltip: {
                callbacks: {
                    ...
                    label: t => t
                        .chart
                        .data
                        .labels[t.dataIndex] + ": " + t.formattedValue
                }
            }
        },
        scales: {
    ...
    class Gn extends Ds {
        ...
        draw(t, e) {
            const i = this.options;
            this.skip || i.radius < .1 || !Jt(this, e, this.size(i) / 2) || (
    ...
    var no = Object.freeze(
        {__proto__: null, ArcElement: Vn, LineElement: qn, PointElement: Gn, BarElement: so}
    );
    function oo(t) {
        if (t._decimated) {
            const e = t._data;
    ...
    var So = {
        ...
        beforeDatasetDraw(t, e, i) {
            ...
            s && !1 !== s.fill && "beforeDatasetDraw" === i.drawTime && ko(
                t.ctx,
                s,
                t.chartArea
            )
    ...
    class Oo extends Ds {
        ...
        _drawArgs(t) {
            ...
            return this.isHorizontal()
                ...
                : (
                    "left" === a.position
                        ? (h = i + t, c = n(r, s, e), d = -.5 * _t)
                        : (h = o - t, c = n(r, e, s), d = .5 * _t),
                    l = s - e
                ), {
                titleX: h,
                titleY: c,
        ...
        if (
            ...
            p += f * (
                e.displayColors
                    ...
                    : l.lineHeight
            ) + (x - f) * l.lineHeight + (x - 1) * e.bodySpacing
        }
    ...
    class $o extends Ds {
        ...
        getContext() {
            return this.$context || (
                this.$context = (t = this.chart.getContext(), e = this, i = this._tooltipItems, Ye(t, {
                    tooltip: e,
                    tooltipItems: i,
                    type: "tooltip"
                }))
    ...
    class Qo extends Bs {
        ...
        handleTickRangeOptions() {
            ...
            i <= 0 && n(a(s, -1)),
            s <= 0 && o(a(i, 1)),
            this._zero && this.min !== this._suggestedMin && i === a(this.min, 0) && n(
                a(i, -1)
            ),
            this.min = i,
            this.max = s
        ...
        buildTicks() {
            const t = this.options,
                e = function (t, e) {
                    ...
                    const h = q(t.max, o);
                    return n.push({value: h, major: Jo(o)}),
                    n
                }({
                    min: this._userMin,
                    max: this._userMax
    ...
    class la extends Go {
        ...
        determineDataLimits() {
            ...
            this.min = X(t) && !isNaN(t)
                ? t
                : 0,
            this.max = X(e) && !isNaN(e)
                ? e
                : 0,
            this.handleTickRangeOptions()
        }
        ...
        getIndexAngle(t) {
            return Nt(
                t * (yt / (this._pointLabels.length || 1)) + It(this.options.startAngle || 0)
            )
        }
