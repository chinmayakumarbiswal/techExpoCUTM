...
$getDataForTable=getAllSchoolByAdminForList($db); 
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="index.html" class="logo d-flex align-items-center">
        ...
        <span class="d-none d-lg-block">CCCD</span>
      </a>
            ...
            <div class="card-body">
              ...
              <form action="" method="post">
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="school" list="schoolName" required>
                    <datalist id="schoolName">
                      <?php    
                        $getSchoolAll=getAllSchoolByAdmin($db);
                        foreach($getSchoolAll as $getSchoolAlls){
                      ?>
                        <option value="<?=$getSchoolAlls['school']?>"><?=$getSchoolAlls['school']?></option>
                      <?php    
                        }
                      ?>
                  </datalist>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <button type="submit" class="btn btn-primary" name="addSchool">Add</button>
                  </div>
                </div>
